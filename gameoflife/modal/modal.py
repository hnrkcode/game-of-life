...
class Modal(pygame.sprite.Sprite):
    ...
    def __init__(self) -> None:
        ...
        content = [
            InfoText("CONTROLS", size=settings.H2, pos=(int(width / 2) - 40, 20)),
            # Keyboard controls.
            ...
            InfoText("Zoom:", size=settings.TEXT, pos=(80, 180)),
            InfoText("+/-", size=settings.TEXT, pos=(180, 180)),
            InfoText("Quit:", size=settings.TEXT, pos=(80, 200)),
            InfoText("ESC", size=settings.TEXT, pos=(180, 200)),
            # Mouse controls.
            InfoText("Mouse controls", size=settings.H4, pos=(80, 230)),
            InfoText("Draw cells:", size=settings.TEXT, pos=(80, 255)),
            InfoText("Left", size=settings.TEXT, pos=(180, 255)),
            InfoText("Erase cells:", size=settings.TEXT, pos=(80, 275)),
            InfoText("Right", size=settings.TEXT, pos=(180, 275)),
            InfoText("Choose pattern:", size=settings.TEXT, pos=(80, 295)),
            InfoText("Ctrl + Scroll", size=settings.TEXT, pos=(180, 295)),
            InfoText("Paste pattern:", size=settings.TEXT, pos=(80, 315)),
            InfoText("Ctrl + Left click", size=settings.TEXT, pos=(180, 315)),
            InfoText("Zoom:", size=settings.TEXT, pos=(80, 335)),
